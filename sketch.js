...
function setup(){
    ...
    //first
    box17=new Box(1000,350,50,70)
    box18=new Box(1050,350,50,70)
    box19=new Box(1100,350,50,70)
    box20=new Box(1150,350,50,70)
    box21=new Box(1200,350,50,70)

    //second

    box22=new Box(1050,300,50,70)
    box23=new Box(1100,300,50,70)
    box24=new Box(1150,300,50,70)

//third

box25=new Box(1100,200,50,70)
